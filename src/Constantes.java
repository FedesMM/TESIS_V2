...
public class Constantes {
    ...
    */
    ...
    //TODO se tiene que leer de region
    public static float[]  restriccionProductividadProductorE = new float[]
            {1200,600,2100,2100,1200,600,2100,2100,1200,600,2100,2100,1200,600,2100,2100};
    ...
    //TODO cuando pasemos a problema no deberia ser necesario
    public static List<Integer> productoresActivos= new ArrayList<Integer>();

    /****
     * Constantes de Configuracion del Algoritmo
     * ****/
    //Parametros LS
    ...
    /****
     * Variables de Configuracion para el  Usuario
     * ****/
    ...
    //Esto va aca por que el modulo variables deberia poder acceder a las constantes peor no al reves
    ...
    /**Devuelve un map con los pesos en pesoBase**/
